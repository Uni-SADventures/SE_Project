...
import unisadventures.se_project.model.character.BasicEnemy;
...
public class ActionManager implements MovementsInterface {
    ...
    private final PlayerCharacter _ch;
    ...
    public ActionManager(Handler _handler, PlayerCharacter _ch) {
    ...
    private boolean rightCollisionEnemies() {
        if (State.getState() instanceof GameState) {
            ...
            for (BasicEnemy enemy : state.getEnemies()) {
