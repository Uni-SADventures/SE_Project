...
public class MenuState extends State {
    ...
    public void tick() {
        if(_handler.getKeyManager().up)
            State.setState(new GameState(_handler,1));
    ...
    public void displayView(Graphics g) {
        ...
        view.renderMenuTitle(g, _menu.getTitleImageId(), _displayWidth - 40, 80, 20, 20);
        view.renderText(g, "Press Enter", (int) _displayWidth/2 - 20, _displayHeight - 20);
    }
