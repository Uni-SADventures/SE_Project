...
public class LoadingState extends State {
    ...
    public void displayView(Graphics g) {
        _view.renderLoadingBackground(g, _loading.getBackgroundImageId(), _displayWidth, _displayHeight);
        _view.renderLoadingTitle(g, _loading.getTitleImageId(), _displayWidth - 40, 80, 20, 20);
        _view.renderText(g, "", (int) _displayWidth/2 - 20, _displayHeight - 20);
    }
